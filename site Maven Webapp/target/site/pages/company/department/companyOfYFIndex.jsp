...
<html>
  ...
  <body background="../static/img/bg.jpg">
 	...
 	<div class="panel panel-default">
	 	<div class="panel-body" style="width: auto;height: 950px;">
		 	<div style="width:70%;height: 100%;float: left;">
				  ...
				  <div class="tab-content" style="width:100%;height: 100%;">
				    ...
				    <div role="tabpanel" class="tab-pane fade" id="parallel2" style="width:1310px;height: 920px;"></div>
				    <div role="tabpanel" class="tab-pane fade" id="parallel3" style="width:1310px;height: 920px;"></div>
				  </div>
			</div>
 	...
 	<script type="text/javascript">
 		...
 		$.get('${pageContext.request.contextPath}/static/parallelDataIndex20180422.json', function (data) {
			 	var schema = [
			 	     {name: 'date', index: 0, text: '小组'},
			 	    {name: 'AQIindex', index: 1, text: '人员id'},
			 	    {name: 'PM25', index: 2, text: '登陆ip'},
			 	    {name: 'SO2', index: 3, text: '协议'},
			 	    /* {name: '等级', index: 4, text: '协议类型'},
			 	    {name: 'CO', index: 5, text: ' 接收ip'} */
			 	   {name: 'CO', index: 4, text: ' 接收ip'}
			 	...
			 	parallelcharts.setOption(paralleloption = {
			 	    parallelAxis: [
			 	        ...
			 	        {dim: 3, name: schema[3].text, type: 'category', data: ['ftp','mongodb','mysql','postgresql','sftp','ssh','tds']},
			 	       /* {dim: 4, name: schema[4].text,type: 'category', data: ['文件传输','mongodb数据库','mysql数据库','postgresql数据库','安全文件传输','远程登陆','sqlserver数据库']},
			 	        {dim: 5, name: schema[5].text, type: 'category', data: ['10.5.71.60','10.50.50.26','10.50.50.28','10.50.50.29','10.50.50.30','10.50.50.31','10.50.50.33','10.50.50.34','10.50.50.35','10.50.50.36','10.50.50.37','10.50.50.38','10.50.50.39','10.50.50.40','10.50.50.41','10.50.50.42','10.50.50.43','10.50.50.44','10.50.50.45','10.50.50.46','10.50.50.47','10.50.50.48','10.50.50.49','10.63.120.70','10.7.133.15','10.7.133.16','10.7.133.18','10.7.133.19','10.7.133.20','10.7.133.21','10.7.133.22']}
			 	    */ 
			 	       {dim: 4, name: schema[4].text, type: 'category', data: ['10.5.71.60','10.50.50.26','10.50.50.28','10.50.50.29','10.50.50.30','10.50.50.31','10.50.50.33','10.50.50.34','10.50.50.35','10.50.50.36','10.50.50.37','10.50.50.38','10.50.50.39','10.50.50.40','10.50.50.41','10.50.50.42','10.50.50.43','10.50.50.44','10.50.50.45','10.50.50.46','10.50.50.47','10.50.50.48','10.50.50.49','10.63.120.70','10.7.133.15','10.7.133.16','10.7.133.18','10.7.133.19','10.7.133.20','10.7.133.21','10.7.133.22']}
			 	     ],
			 	    parallel: {
			 	        left: '3%',
			 	        right: '8%',

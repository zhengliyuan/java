...
<html>
  ...
  <body background="../static/img/bg.jpg">
 	...
 	<div class="panel panel-default">
	 	<div class="panel-body" style="width: auto;height: 3000px;">
		 	<div  id="parallel" style="width:100%;height: 100%;float: left;"></div>
		 	<!-- <div style="width: 30%;height: 100%;float: right;">
		 		<div id="graph" style="width: 100%;height: 450px"></div>
		 		<div id="worldCloud" style="width: 100%;height: 450px"></div>
		 	</div> -->
	 	</div>
 	</div>
